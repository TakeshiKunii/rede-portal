...
<p><?php echo JText::_('COM_EASYBLOG_INSTALLATION_TECHNICAL_REQUIREMENTS_DESC'); ?></p>

<p><?php echo JText::_('COM_EASYBLOG_INSTALLATION_TECHNICAL_REQUIREMENTS_DESC_2');?></p>

<?php if( !$hasErrors ){ ?>
<hr />
<p><?php echo JText::_('COM_EASYBLOG_INSTALLATION_TECHNICAL_REQUIREMENTS_MET');?></p>
<?php } ?>
	...
	<table class="table">
		<thead>
			<tr>
				...
				<td class="text-center" width="30%">
					<?php echo JText::_('COM_EASYBLOG_INSTALLATION_TECHNICAL_REQUIREMENTS_RECOMMENDED');?>
				</td>
				<td class="text-center" width="30%">
					<?php echo JText::_('COM_EASYBLOG_INSTALLATION_TECHNICAL_REQUIREMENTS_CURRENT');?>
				</td>
			</tr>
		</thead>
		...
		<tbody>
			<tr class="<?php echo version_compare($phpVersion, '5.3.10') == -1 ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						<span class="label label-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP');?></span> PHP Version
						<i class="icon-info hasTooltip" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP_VERSION_TIPS');?>" data-toggle="tooltip" data-placement="bottom"></i>

						<?php if (version_compare($phpVersion , '5.3.10') == -1 ){ ?>
						<a href="https://stackideas.com/docs/easyblog/administrators/welcome/system-requirements" class="pull-right btn btn-es-danger btn-mini"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
			...
			<tr class="<?php echo !$gd ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						<span class="label label-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP');?></span> GD Library
						<i class="icon-info hasTooltip" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP_GD_TIPS');?>" data-toggle="tooltip" data-placement="bottom"></i>

						<?php if (!$gd) { ?>
						<a href="https://stackideas.com/docs/easyblog/administrators/welcome/system-requirements" target="_blank" class="pull-right btn btn-es-danger btn-mini"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
				<td class="text-center text-success">
			...
			<tr class="<?php echo !$curl ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						<span class="label label-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP');?></span> CURL Library

						<?php if (!$curl) { ?>
						<a href="https://stackideas.com/docs/easyblog/administrators/welcome/system-requirements" target="_blank" class="btn btn-primary btn-xs"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
				<td class="text-center text-success">
			...
			<tr class="<?php echo $magicQuotes ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						<span class="label label-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP');?></span> Magic Quotes GPC
				...
				<td class="text-center text-<?php echo $magicQuotes ? 'error' : 'success';?>">
					<?php if (!$magicQuotes) { ?>
						<?php echo JText::_('COM_EASYBLOG_SETUP_DISABLED');?>
					<?php } else { ?>
						<?php echo JText::_('COM_EASYBLOG_SETUP_ENABLED');?>
					<?php } ?>
				</td>
			</tr>
			<tr class="<?php echo $memoryLimit < 64 ? 'error' : '';?>">
				<td>
					<span class="label label-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP');?></span> memory_limit
				</td>
				<td class="text-center text-success">
			...
			<tr>
				<td>
					<span class="label label-inverse"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_MYSQL' );?></span> MySQL Version
					<i class="icon-info hasTooltip" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_MYSQL_VERSION_TIPS' );?>" data-toggle="tooltip" data-placement="bottom"></i>
				</td>
				<td class="text-center text-success">
					5.0.4
				</td>
			...
			<tr class="<?php echo !$file->writable ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						...
						<a href="javascript:void(0);" class="btn btn-es-inverse btn-mini pull-right" data-permissions-info><?php echo JText::_('COM_EASYBLOG_INSTALLATION_INFO' ); ?></a>
						<a href="javascript:void(0);" class="btn btn-es-danger btn-mini pull-right mr-5"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_HOW_TO_FIX' ); ?></a>
						<?php } ?>
					</div>
				</td>
				...
				<?php if ($file->writable) { ?>
				<td class="text-center text-success">
					<?php echo JText::_('COM_EASYBLOG_INSTALLATION_PERMISSIONS_WRITABLE' );?>
				</td>
				<?php } else { ?>
				<td class="text-center text-error">
