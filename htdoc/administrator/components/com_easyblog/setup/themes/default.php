...
<head>
	...
	<link type="text/css" href="<?php echo EB_SETUP_URL;?>/assets/styles/theme.css" rel="stylesheet" />
	...
	<div class="header text-center">
		<div class="container">
			<div class="col-cell" style="padding-right: 20px;">
				<img src="<?php echo EB_SETUP_URL;?>/assets/images/logo.png" height="64" width="64" />
			</div>
			<div class="col-cell text-left">
				<h2 style="color: #fff; font-weight: 400; margin: 0 0 8px; font-size: 24px;">
					<?php echo JText::_('EasyBlog Installer');?>
				</h2>

				<div>
					<?php echo JText::_('The best authoring and blogging platform for your Joomla! site.');?>
				</div>
			</div>
