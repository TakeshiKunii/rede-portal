...
<div class="body auto">
    <div class="tabs " id="tabs">
        <ul class="nav nav-tabs">
            ...
            <li <?php echo($tab == 'authentication' ? 'class="active"' : '');  echo $publicApiAction; ?> >
                    ...
                    <textarea class="form-control" id="description" name="apidata[description]"
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="phone">
                                    <?php echo JText::_('COM_APIPORTAL_APPLICATION_EDIT_GENERAL_PHONE_LABEL'); ?>:
                                </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="email">
                                    <?php echo JText::_('COM_APIPORTAL_APPLICATION_EDIT_GENERAL_EMAIL_LABEL'); ?>:
                                </label>
