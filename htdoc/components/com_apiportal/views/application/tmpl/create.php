          ...
          <span class="help-block">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="organization">
                    <?php echo JText::_('COM_APIPORTAL_APPLICATION_CREATE_GENERAL_ORGANIZATION_LABEL'); ?>:
                </label>
                ...
                <?php } else { ?>
                    <p class="col-sm-4 form-control-static" id="organization"
                       name="organization"><?php echo ApiPortalHelper::cleanHtml($organizationName); ?></p>
                <?php } ?>
            </div>
            <!-- .form-group -->
          ...
          <textarea class="form-control" id="description" name="apidata[description]"
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="phone">
                    <?php echo JText::_('COM_APIPORTAL_APPLICATION_CREATE_GENERAL_PHONE_LABEL'); ?>:
                </label>

                <div class="col-sm-4">
                    <input type="tel" class="form-control" id="phone" name="apidata[phone]"
                           value="<?php echo $this->escape($data['phone']); ?>">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="email">
                    <?php echo JText::_('COM_APIPORTAL_APPLICATION_CREATE_GENERAL_EMAIL_LABEL'); ?>:
                </label>

                <div class="col-sm-4">
                    <input type="email" class="form-control" id="email" name="apidata[email]"
                                    ...
                                    <?php if ($data['apis']) { ?>
                                        <?php foreach ($data['apis'] as $apiId): ?>
                                            <?php if ($available->apiId == $apiId) { ?>
                                                <input type="checkbox" name="apidata[apis][]"
