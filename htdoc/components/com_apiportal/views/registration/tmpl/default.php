  ...
  <fieldset>
    ...
    <div class="form-group">
      <label class="control-label" for="token">
        <?php echo JText::_('COM_APIPORTAL_REGISTRATION_ORGANIZATION_CODE_LABEL'); ?>:
      </label>
      <div class="form-inline">
          <div style="white-space: nowrap"> <!-- nowrap required to keep span text on same line as inut field -->
            <input type="text" class="form-control" tabindex='5' id="token" name="apidata[token]"
              value="<?php echo $this->escape($data['token']); ?>">
            <span class="optional">
              <?php echo JText::_('COM_APIPORTAL_REGISTRATION_ORGANIZATION_CODE_OPTIONAL_TEXT'); ?>
            </span>
          </div>
        <span class="help-block">
          <?php echo JText::_('COM_APIPORTAL_REGISTRATION_ORGANIZATION_CODE_HELP_TEXT'); ?>
        </span>
      </div>
    </div><!-- .form-group -->
