...
<?php } ?>
  <h1 class="auto"><?php echo JText::_('Teste01'); ?></h1>
        ...
        <fieldset>
          ...
          <span class="help-block">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="tel" class="form-control" id="phone" name="userdata[phone]"
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="description">
                    <?php echo JText::_('COM_APIPORTAL_USER_EDIT_DESCRIPTION_LABEL'); ?>:
                </label>

                <div class="col-sm-4">
          <textarea class="form-control" id="description" name="userdata[description]"
