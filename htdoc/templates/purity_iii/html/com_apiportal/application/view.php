        ...
        <div class="tab-pane fade <?php echo($tab == 'details' ? 'in active' : ''); ?>" id="details">
            ...
            <div id="general" class="col-sm-12 panel panel-default">
                ...
                <div class="col-sm-5">
                  ...
                  <div class="control-group row">
                        <label class="col-sm-3 control-label" for="pv">
                            <?php echo JText::_('COM_APIPORTAL_APPLICATION_VIEW_GENERAL_PV_LABEL'); ?>:
                        </label>

                        <div class="col-sm-9" id="pv"
                             name="pv"><?php echo $this->escape($application->pv); ?></div>
                    </div>
                    <!-- .control-group -->

                    <div class="control-group row">
                        <label class="col-sm-3 control-label" for="token">
                            <?php echo JText::_('COM_APIPORTAL_APPLICATION_VIEW_GENERAL_TOKEN_LABEL'); ?>:
                        </label>

                        <div class="col-sm-9" id="pv"
                             name="pv"><?php echo $this->escape($application->token); ?></div>
                    </div>
                    <!-- .control-group -->
